...
/** Grouped site-wide FAQ for /faq — short group labels for compact UI. */
...
export const SITE_FAQ_GROUPS: FaqGroup[] = [
  {
    ...
    items: [
      ...
      {
        q: "How is goBeauty different from Instagram or Google?",
  ...
  },
  {
    ...
    items: [
      {
        q: "Can I shop beauty products on goBeauty?",
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "How can beauty brands list products?",
